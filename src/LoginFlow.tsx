...
const LoginScreen: React.FC = () => {
    ...
    const checkBiometrics = async () => {
      ...
      if (getBiometricsFromLocal) {
        ...
        if (biometrics) {
          ...
          const isAccessTokenValid = accessToken ? await checkTokenStillValid(accessToken) : null
          const isRefreshTokenValid = refreshToken ? await checkTokenStillValid(refreshToken) : null
          ...
          if (isAccessTokenValid) {
            ...
            try {
              ...
              const newToken = await apiClient<LoginResponse>('refresh-token', 'POST', null, null, {
                refreshToken,
              })
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const response = await apiClient<LoginResponse>('login', 'POST', null, null, {
